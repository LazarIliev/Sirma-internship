...
public class CounterWait implements Runnable {
	 ...
	 */
	CounterWait(int maxCount, AtomicBoolean run) {
	 ...
	 * <p>
	 * On every loop increment count with 1 and wait 1 second in this case uses a {@link Object#wait(long)} and print the count.
	 */
	@Override
	public void run() {
